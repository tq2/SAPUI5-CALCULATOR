		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Calculator",
									"targetURL": "#comcalculatorcalculator-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comcalculatorcalculator-display": {
								"semanticObject": "comcalculatorcalculator",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.calculator.calculator",
									"url": sap.ui.require.toUrl("com/calculator/calculator")
								}
							}
						}
					}
